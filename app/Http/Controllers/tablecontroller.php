...
class tablecontroller extends Controller {
    ...
    public function showtable() {
        ...
        $cfg = (new GridConfig())
            ...
            (new FieldConfig('name'))->setSortable(true)->addFilter((new FilterConfig)->setOperator(FilterConfig::OPERATOR_LIKE)),
            (new FieldConfig('email'))->setSortable(true)->addFilter((new FilterConfig)->setOperator(FilterConfig::OPERATOR_LIKE)),
            (new FieldConfig('created_at'))->setSortable(true)->addFilter((new FilterConfig)->setOperator(FilterConfig::OPERATOR_LIKE)),
            (new FieldConfig('updated_at'))->setSortable(true)->addFilter((new FilterConfig)->setOperator(FilterConfig::OPERATOR_LIKE)),
//            (new FieldConfig('interest'))->setSortable(true)->addFilter((new FilterConfig)->setOperator(FilterConfig::OPERATOR_LIKE)),
//            (new FieldConfig('mobile'))->setLabel('Phone Number')->setSortable(true)->addFilter((new FilterConfig)->setOperator(FilterConfig::OPERATOR_LIKE)),
        ]);
        $grid = new Grid($cfg);
        /* $grid = Grids::make($cfg); */
    ...
    public function getExample1() {
        ...
        return view('table', compact('grid', 'text'));
    }
            ...
            (new GridConfig)
                ...
                ->setColumns([
                    ...
                    (new FieldConfig)
                        ...
                        ->setLabel('Action')
                        ->setCallback(function ($val) {
                            return "<a href='/user/edit/{$val}'><span class='glyphicon glyphicon-user'></span>edit</a>";
                        })
                        ->setSortable(true)
                        ->addFilter(
                            (new FilterConfig)
